...
<div id="page-wrapper">
  ...
  <img src="image\음오아예.jpg" class="absolute1" border="3px" width="100px" height="100px" align="right">
  <img src="image\그리워하다.jpg" class="absolute2" border="3px" width="100px" height="100px" align="right">
  <img src="image\외톨이야.jpg" class="absolute3" border="3px" width="100px" height="100px" align="right">
  <img src="image\사랑했었다.jpg" class="absolute4" border="3px" width="100px" height="100px" align="right">
    
 <h4>1. MC THE MAX - 어디에도</h4> <audio src="music\2010\M.C THE MAX - 어디에도.mp3" autoplay controls></audio><br>
  <util:line color= "blue" size= "73"/><br>
 <h4>2. 마마무 - 음오아예</h4> <audio src="music\2010\마마무 - 음오아예.mp3" controls></audio><br>
  <util:line color= "blue" size= "73"/><br>
 <h4>3. 비투비 - 그리워하다</h4> <audio src="music\2010\비투비 - 그리워하다.mp3" controls></audio><br>
  <util:line color= "blue" size= "73"/><br>
 <h4>4. 씨엔블루 - 외톨이야</h4> <audio src="music\2010\씨엔블루 - 외톨이야.mp3" controls></audio><br>
  <util:line color= "blue" size= "73"/><br>
 <h4>5. 유홍기, 유회승 - 사랑했었다</h4> <audio src="music\2010\이홍기유회승 - 사랑했었다.mp3" controls></audio><br>
 </div>
 </div>
</div>
